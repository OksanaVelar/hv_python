...
def Check_step(engaged, try_gamer):
    check_result = True
    for i in range (len(engaged)):
        if engaged[i] == try_gamer:
            check_result = False
    return(check_result)
